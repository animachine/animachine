  ...
  render() {
    ...
    return (
      <div>
        <div style={{transform: 'scale(0.5)'}}>
          <div className='shoulder' style={shoulderStyle}>
            <div className='armGroup' style={armStyle}>
              <div className='forearmGroup' style={forearmStyle}>
                <svg className='pincerGroup' style={pincerStyle} width="170" height="140">
                  <polygon className='pincerL' fill='#343434' points='29.7,69 64.3,118.7 64,137.9 0,65.6 65.6,0 83.9,18.3'/>
                  <polygon className='pincerR' fill='#343434' points='144.2,69 109.6,118.7 109.9,137.9 173.9,65.6 108.3,0 90,18.3'/>
                </svg>
          ...
          <svg style={{overflow: 'visible'}}>
            <g className='conveyorGroup'>
              ...
              <path className='wheelL wheel' fill='#343434' d='M527,521v-8h-7c-0.5-3.6-1.8-7-3.7-9.9l5.4-5.4l-5.7-5.7l-5.2,5.2c-2.6-2-5.6-3.4-8.9-4.2V486h-8v6.6
              ...
              <path className='wheelR wheel' fill='#343434' d='M754,521v-8h-6.6c-0.5-3.6-1.8-7-3.7-9.9l5.4-5.4l-5.7-5.7l-5.4,5.2c-2.6-2-5-3.4-9-4.2V486h-8v6.6
            ...
            <path className='base' fill='#343434' stroke='#ededed' strokeWidth='4' d='M290.9,577.5H24.1c-5.6,0-10.1-4.5-10.1-10.1V436.9c0-5.6,4.5-10.1,10.1-10.1h266.8c5.6,0,10.1,4.5,10.1,10.1
            	v130.5C301,572.9,296.5,577.5,290.9,577.5z'/>
            <path className='minirobot' fill='#2967A7' d='M525.4,413.3h-10.9v10.2h10.9V413.3L525.4,413.3z M517.3,420.3c-1,0-1.8-0.8-1.8-1.8c0-1,0.8-1.8,1.8-1.8
        ...
        <a
          href='https://codepen.io/chrisgannon/details/PqOOrR'
          style={{position: 'fixed', top: 12, right: 12, color: 'black', zIndex: 2000}}
        >
          <span className='fa fa-codepen'/>
          <span style={{fontFamily: 'Open Sans', fontSize: 12, margin: 6}}>forked from codepen</span>
        </a>
      </div>
    )
  }
