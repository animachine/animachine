        ...
        <div style={{transform: 'scale(0.5)'}}>
          ...
          <svg style={{overflow: 'visible'}}>
            <g className='conveyorGroup'>
              ...
              <path className='wheelL' fill='#343434' d='M527,521v-8h-7c-0.5-3.6-1.8-7-3.7-9.9l5.4-5.4l-5.7-5.7l-5.2,5.2c-2.6-2-5.6-3.4-8.9-4.2V486h-8v6.6
              ...
              <path className='wheelR' fill='#343434' d='M754,521v-8h-6.6c-0.5-3.6-1.8-7-3.7-9.9l5.4-5.4l-5.7-5.7l-5.4,5.2c-2.6-2-5-3.4-9-4.2V486h-8v6.6
