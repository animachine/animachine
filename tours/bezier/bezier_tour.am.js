...
function (inputs) {
    ...
    var timelines = [[{"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"x":"-152.5027743501769px"},"duration":0}],[{"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"y":"8.899659132951882px"},"duration":0}],[{"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"rotationZ":"-21.836872668125434deg"},"duration":0}],[{"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"scaleX":0.7541946030110847},"duration":0}],[{"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"scaleY":0.7541946030110847},"duration":0}],[{"duration":0,"options":{"ease":new Ease(BezierEasing(0,0,1,1)),"transformOrigin":"29.42714285714285% 82.78535031847134% "}}]],
